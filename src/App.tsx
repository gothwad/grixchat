...
import ProfileTab from './features/profile/screens/ProfileTab';

// Lazy Loading Features & Screens
const ChatsTab = React.lazy(() => import('./features/chat/screens/ChatsTab'));
...
const ChatLayout = React.lazy(() => import('./features/chat/screens/ChatLayout'));
const ChatScreen = React.lazy(() => import('./features/chat/screens/ChatScreen'));
const MessagesListScreen = React.lazy(() => import('./features/chat/screens/MessagesListScreen'));
const HideChatScreen = React.lazy(() => import('./features/chat/screens/HideChatScreen'));
const ArchivedChatScreen = React.lazy(() => import('./features/chat/screens/ArchivedChatScreen'));
const HideChatSettings = React.lazy(() => import('./features/chat/screens/HideChatSettings'));
const MessageRequestsScreen = React.lazy(() => import('./features/chat/screens/MessageRequestsScreen'));
const SearchUserScreen = React.lazy(() => import('./features/chat/screens/SearchUserScreen'));
const ChatSettingsScreen = React.lazy(() => import('./features/chat/screens/ChatSettingsScreen'));
...
const EditProfileScreen = React.lazy(() => import('./features/profile/screens/EditProfileScreen'));
const UserProfileScreen = React.lazy(() => import('./features/profile/screens/UserProfileScreen'));


const CallsTab = React.lazy(() => import('./features/call/screens/CallsTab'));
...
const NewGroupScreen = React.lazy(() => import('./features/chat/screens/NewGroupScreen'));
const GroupSettingsScreen = React.lazy(() => import('./features/chat/screens/GroupSettingsScreen'));
...
const CallScreen = React.lazy(() => import('./features/call/screens/CallScreen'));
...
const ImagePreviewScreen = React.lazy(() => import('./features/chat/screens/ImagePreviewScreen'));
...
export default function App() {
  ...
  // Guard Logic
  const needsVerification = user && !user.email_confirmed_at && !(user.app_metadata?.providers || []).some((p: string) => ['google'].includes(p));

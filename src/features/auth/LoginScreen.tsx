...
import { Eye, EyeOff, Mail, Lock, User as UserIcon, ArrowRight, Apple, Twitter, Facebook } from 'lucide-react';
    ...
    <div className="h-full overflow-y-auto bg-[var(--bg-main)] flex flex-col items-center relative font-sans">
      ...
      <div className="w-full px-8 pt-8 pb-32 pb-safe z-10 flex flex-col items-center min-h-full relative max-w-md mx-auto">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-4">
          ...
          <button 
            type="submit"
            disabled={loading || (!isForgotPassword && (googleLoading || appleLoading || twitterLoading || facebookLoading || !identifier || password.length < 6)) || (isForgotPassword && !identifier)}
